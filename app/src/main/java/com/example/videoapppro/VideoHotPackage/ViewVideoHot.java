...
public class ViewVideoHot extends AppCompatActivity implements  SurfaceHolder.Callback, MediaPlayer.OnPreparedListener,
    ...
    private static final String TAG = "ViewVideoHot";
    ArrayList<Video> listhot;
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        setContentView(R.layout.activity_view_video_hot);
        rc_viewvideohot = findViewById(R.id.rc_viewvideohot);
        ...
        urlYoutube = intent.getStringExtra("file_mp4");
        ...
        try {
            ...
            mMediaPlayer.setDataSource(getBaseContext(), Uri.parse(urlYoutube));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                for (int i = 0 ; i<array.length();i++){
                    ...
                    listhot.add(new Video(objectVideo.getString("id"),objectVideo.getString("title"),
                            objectVideo.getString("avatar"),objectVideo.getString("file_mp4")));
                }
                shimmerFrameLayout.startShimmer();
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getApplicationContext(),RecyclerView.VERTICAL,false);
                final VideoViewAdapter VideoViewAdapter = new VideoViewAdapter(listhot);
                rc_viewvideohot.setAdapter(VideoViewAdapter);
                rc_viewvideohot.setLayoutManager(layoutManager);
